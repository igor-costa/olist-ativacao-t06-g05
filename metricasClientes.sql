...
tb_orders_sellers AS (
    ...
    SELECT DISTINCT
        ...
        CAST(DATE_TRUNC('MONTH', o.order_purchase_timestamp) AS DATE) AS safra_mes
        --LAST_DAY(o.order_purchase_timestamp) AS safra_mes
    ...
    --WHERE oi.seller_id = '0ffa40d54288e4f3499b8780dd0f144f'
...
tb_periodos AS (
    ...
    SELECT
        ...
        safra_mes,
        '28d' AS periodo,
        LAST_DAY(safra_mes) AS dt_inicio,
        LAST_DAY(safra_mes) - INTERVAL 28 DAYS AS dt_fim
    FROM tb_safras
    ...
    SELECT
        ...
        '56d',
        LAST_DAY(safra_mes) AS dt_inicio,
        LAST_DAY(safra_mes) - INTERVAL 56 DAYS AS dt_fim
    FROM tb_safras
    ...
    SELECT
        ...
        '365d',
        LAST_DAY(safra_mes) AS dt_inicio,
        LAST_DAY(safra_mes) - INTERVAL 365 DAYS AS dt_fim
    FROM tb_safras
    ...
    SELECT
        ...
        'full',
        LAST_DAY(safra_mes) AS dt_inicio,
        CAST('1900-01-01' AS DATE) AS dt_fim
    FROM tb_safras
